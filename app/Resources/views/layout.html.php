				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="white-text"><?= $this->input("myHeadline", ['placeholder' => 'Hero text']);?></h1>
							<p class="white-text"><?= $this->input("mySubline",['placeholder' => 'Hero sub-text']);?></p>
